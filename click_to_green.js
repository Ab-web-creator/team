...
const waar_btn1 = document.querySelector(".red_green1");
const waar_btn2 = document.querySelector(".red_green2");
const waar_btn3 = document.querySelector(".red_green3");
const waar_btn4 = document.querySelector(".red_green4");
const waar_btn5 = document.querySelector(".red_green5");
const waar_btn6 = document.querySelector(".red_green6");
const waar_btn7 = document.querySelector(".red_green7");
...
waar_btn5.addEventListener("click", () => {
